        ...
        {testimonial.id === 1 && <div className="absolute right-20 top-0 z-0"><Image src={quote} alt="quote" width="104px" height="102px"/></div>}
         <div className="flex">
            <div className="inline-block w-[32px] h-[32px] self-end">
              <Image src={testimonial.profile.img} alt={testimonial.id} width="32px" height="32px" className={`border-2 border-transparent rounded-full ${testimonial.id === 1 ? '' : testimonial.id === 4 && 'border-primary1'}`}/>
            </div>
